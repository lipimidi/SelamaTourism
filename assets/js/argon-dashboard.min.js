...
let iconNavbarSidenav = document.getElementById("iconNavbarSidenav"),
  ...
  function toggleSidenav() {
    if (body.classList.contains(className)) {
      ...
      sidenav.classList.remove("bg-white", "bg-transparent"); // Remove both classes
      sidenav.classList.add("bg-transparent"); // Reset to transparent initially
    } else {
      // Open sidenav
      body.classList.add(className);
      sidenav.classList.remove("bg-transparent");
      sidenav.classList.add("bg-white"); // Add the bg-white class when opening the sidenav
...
function swalAlert(title, text = '', icon = null, buttonText = 'OK', redirectUrl = null) {
  const config = {
      title: title,
      text: text,
