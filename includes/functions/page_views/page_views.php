...
if (isset($_POST['page_view'])) {
    ...
    if ($result && $result->num_rows > 0) {
        ...
        $conn->query("UPDATE page_views SET view_count = view_count + 1 WHERE page_name = '$page_name' ");
    } else {
        // Insert new row
        $conn->query("INSERT INTO page_views (page_name,  view_count) VALUES ('$page_name', 1)");
    }   
